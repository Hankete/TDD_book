...
class SendLoginEmailViewTest(TestCase):
    ...
    def test_adds_succes_message_with_mocks(self, mock_messages):
        response = self.client.post(
    ...
    def test_creates_toke_associated_with_email(self):
        self.client.post(
            "/accounts/send_login_email", data={"email": "edith@example.com"}
        )
...
class LoginViewTest(TestCase):
    ...
    def test_calls_authenticate_uid_from_get_request(self, mock_auth):
